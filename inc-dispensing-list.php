	<section>
		...
		<div class="search_main bg_light6"><div class="w">
			...
			<nav>
				...
				<ul>
					<li><a href="<?php  echo site_url(); ?>/shop/" class="satudora"><span class="l">サツドラ</span><span class="pc">をさがす</span></a><span></span></li>
					<li class="current"><a class="dispensing"><span class="l">調剤薬局</span><span class="pc">をさがす</span></a><span></span></li>
				</ul>
			</nav>
...
<?php 					if ($area_count[$area_name][$location][$small_area] > 0): ?>
								<li><a href="<?php echo site_url(); ?>/shop/dispensing/?area=<?php echo $small_area ?>#result"><?php echo $small_area ?> (<?php echo $count ?>件)</a></li>
<?php 					endif; ?>
<?php 				endforeach; ?>
							</ul>
						</li>
...
<?php 				if ($area_count[$area_name][$location] > 0): ?>
						<li>
							<a href="<?php echo site_url(); ?>/shop/dispensing/?area=<?php echo $location ?>#result"><?php echo $location ?> (<?php echo $value ?>件)</a>
						</li>
<?php 				endif; ?>
<?php 			endif; ?>
<?php 		endforeach; ?>
...
?>
				...
				<div class="search_narrow">
					...
					<dl>
						...
						<dd>
							<ul>
								<li class="sp_w"><input type="checkbox" name="search[]" value="ドラッグストアー併設" id="service02main"<?php service_checked("ドラッグストアー併設"); ?>>
									<label for="service02main">
										<span class="checkbox"><span></span></span>
										<span class="img"><img src="<?php  echo get_template_directory_uri(); ?>/img/ico_service03.png" width="40" height="40" alt="ドラッグストアー併設"></span>
										<span class="txt">ドラッグストアー<br>併設</span>
									</label>
								</li>
								...
								<li><input type="checkbox" name="search[]" value="夜間営業店" id="service07main"<?php service_checked("夜間営業店"); ?>>
									<label for="service07main">
										<span class="checkbox"><span></span></span>
										<span class="img"><img src="<?php  echo get_template_directory_uri(); ?>/img/ico_late.png" width="40" height="40" alt="夜間営業店"></span>
										<span class="txt">夜間営業店<br><span>※18時以降</span></span>
									</label>
								</li>
							</ul>
						</dd>
		...
		<section class="search_result bg_light3"><div class="w">
			...
			<div class="search_narrow bg_light6">
				...
				<form action="<?php echo site_url(); ?>/shop/dispensing/#result" method="get">
...
<?php endif;?>
					...
					<dl>
						...
						<dd>
							<ul>
								<li class="sp_w"><input type="checkbox" name="search[]" value="ドラッグストアー併設" id="service02result"<?php service_checked("ドラッグストアー併設"); ?>>
								...
								<li><input type="checkbox" name="search[]" value="夜間営業店" id="service07result"<?php service_checked("夜間営業店"); ?>>
							...
							</ul>							<p class="btn"><button class="box_link">絞り込む</button></p>
						</dd>
					</dl>				</form>
			<!-- /.search_narrow --></div>
...
$service_search = [
	'ドラッグストアー併設'			=> [ 'key' => 'facility_service', 'value' => '03', 'compare' => 'LIKE' ],
	'第一種医薬品取扱'					=> [ 'key' => 'facility_service', 'value' => '04', 'compare' => 'LIKE' ],
	'夜間営業店'								=> [ 'key' => 'late', 'value' => '夜間', 'compare' => 'LIKE' ],
];
